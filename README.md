This Arduino project implements an interactive 8x8 LED matrix game inspired by Minesweeper. The game uses an Arduino Mega (Atmega328 Chip) to control the LED matrix, 
